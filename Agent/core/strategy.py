...
from Agent.modules.tools import summarize_tools, filter_tools_by_hint
from Agent.modules.decision import generate_plan
...
async def decide_next_action(
    ...
    perception: ProblemPerceptionResult,

...
\i /docker-entrypoint-initdb.d/load_department.sql
\echo 'LOADING employee'
\i /docker-entrypoint-initdb.d/load_employee.sql
\echo 'LOADING dept_emp'
\i /docker-entrypoint-initdb.d/load_dept_emp.sql
\echo 'LOADING dept_manager'
\i /docker-entrypoint-initdb.d/load_dept_manager.sql
\echo 'LOADING title'
\i /docker-entrypoint-initdb.d/load_title.sql
\echo 'LOADING salary'
\i /docker-entrypoint-initdb.d/load_salary1.sql
